...
public class User {
    ...
    private String email;//邮箱1
    private String expireTime;//失效时间 日期精确到秒
    private String lockState;//锁定状态 0锁定 1启动
    private String deptno;//部门编号
    private String allowIps;//允许访问的ip
    private String createTime;//创建时间 精确到秒 日期
    private String createBy;//创建人
    private String editTime;//修改时间 精确到秒
